...
describe("rangeUtil", () => {
  ...
  describe("Can get range grouped list of ranges", () => {
    it('when custom settings should return default range list', () => {
      var groups = rangeUtil.getRelativeTimesList({time_options: []}, '最近 5 分钟');
